...
import com.example.android.popularmoviesstage2.view.EndlessScrollRecyclerView;
...
public class MoviesListFragment extends Fragment {
    ...
    private void registerObserver() {
        ...
        getContext().getContentResolver()
                .registerContentObserver(MovieDatabase.BASE_CONTENT_URI, true, contentObserver);
    }
